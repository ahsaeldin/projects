...
#Region "Methods"
    ...
    Public Function Generate(ByVal outputCodeFile As String,
        ...
        Catch ex As Exception
            ...
            Alerter.REP("Error during compiling macro.", ex, True)
            Return False
        End Try
        Return True
    End Function
    ...
    Public Function Compile() As Boolean
        ...
        Try
            ...
            If oCResults.Errors.Count <> 0 Then
                ...
                For Each cmpError As CodeDom.Compiler.CompilerError In CompilingErrors
                    Hodhod.WriteToErrorLog(cmpError.ErrorText & " @ Line Number " & cmpError.Line, "",
        ...
        Catch ex As Exception
            If Debugger.IsAttached Then Debugger.Break()
            Alerter.REP("Error during compiling", ex, True)
            Return False
        End Try
