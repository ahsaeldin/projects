...
<Assembly: AssemblyTitle("Balora")> 
<Assembly: AssemblyDescription("")> 
<Assembly: AssemblyCompany("Conderella Soft http://www.cacadu.conderella.com")> 
<Assembly: AssemblyProduct("Balora")> 
<Assembly: AssemblyCopyright("Copyright © 2012 , Conderella. All rights reserved.")> 
<Assembly: AssemblyTrademark("")> 

<Assembly: ComVisible(False)> 

'Because NamedPipes is hidden for now.
<Assembly: InternalsVisibleTo("CacaSer")> 
<Assembly: InternalsVisibleTo("Cacadu.Tests.Unit")> 
<Assembly: Obfuscation(Feature:="disable warning EF-4001")> 

'The following GUID is for the ID of the typelib if this project is exposed to COM
<Assembly: Guid("8d85ed40-4c49-4cee-917b-621b7cd32f61")> 
