========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : TrayIcon
========================================================================


AppWizard has created this TrayIcon application for you.  This application
...
TrayIcon.h
    ...
    CTrayIconApp application class.
...
res\TrayIcon.ico
    ...
    icon is included by the main resource file TrayIcon.rc.
...
TrayIconDlg.h, TrayIconDlg.cpp - the dialog
    These files contain your CTrayIconDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in TrayIcon.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CTrayIconDlgAutoProxy class.  This class
