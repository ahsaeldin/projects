========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Balloon
========================================================================


AppWizard has created this Balloon application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Balloon application.
...
res\Balloon.ico
    ...
    icon is included by the main resource file Balloon.rc.
...
BalloonDlg.h, BalloonDlg.cpp - the dialog
    These files contain your CBalloonDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in Balloon.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CBalloonDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Balloon.pch and a precompiled types file named StdAfx.obj.
