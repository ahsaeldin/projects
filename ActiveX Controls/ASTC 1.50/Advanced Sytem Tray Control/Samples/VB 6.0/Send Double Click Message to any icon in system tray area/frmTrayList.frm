...
Object = "{9038CE42-8F6D-11DA-A1C2-C07850C10000}#1.0#0"; "astc.ocx"
Begin VB.Form Form1 
   ...
   Begin VB.CommandButton cmdSendDoubleClickMessage 
      Caption         =   "Send Double Click Message to this icon"
      Height          =   375
      Left            =   4800
      TabIndex        =   4
      Top             =   3840
...
End Sub
'==============================================================================
' Method:       cmdSendDoubleClickMessage_Click
'
' Description:  Send Double Click Message to any icon in system tray area.
'==============================================================================
Private Sub cmdSendDoubleClickMessage_Click()
    Dim WM_LBUTTONDBLCLK As Long
    Dim SelectedIconHwnd As Long
    Dim SelectedIconCallbackMessage As Long
    SelectedIconHwnd = MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 3)
    SelectedIconCallbackMessage = MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 6)
    '//To Send Double Click Message to an icon in system tray area
    WM_LBUTTONDBLCLK = 515
    SendMessage SelectedIconHwnd, SelectedIconCallbackMessage, ByVal 0&, WM_LBUTTONDBLCLK
End Sub
