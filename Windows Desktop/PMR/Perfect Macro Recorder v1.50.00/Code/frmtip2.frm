...
'//* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    GetINIProfileString Stop_Play_back, "0,1,0#" & DefChar & "*", dkey, Len(dkey)
        
    Me.Caption = SoftwareName
        
    lblTip = "Press " & "( " & DecodeKey(dkey) & " )" & " to show " & SoftwareName
         
    '//added next line to check "IsTipWinodw" in "IsTask" to ignore and avoiding adding frmtip2 to the listview
    '//because if frmtip2 added to the listview it will be hided if the user press Hide All button
