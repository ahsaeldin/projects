...
Imports Cacadu.Connectors.ShowMessageBoxFormConnector

Namespace UI
    Friend Class ShowMessageBoxForm

#Region "Properties"
        Property TargetTask As Task
        Property IsLoaded As Boolean = False
        Property IsEditMode As Boolean = False
        Property CreatedAction As New ShowMessageBox
#End Region
...
#End Region
        ...
        Private Sub AlertMessageMemoEdit_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles MessageBoxMemoEdit.EditValueChanged
            If Not IsNothing(MessageBoxMemoEdit.EditValue) AndAlso MessageBoxMemoEdit.EditValue.ToString <> "" Then
