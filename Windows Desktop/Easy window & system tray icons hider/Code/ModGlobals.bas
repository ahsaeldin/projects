...
'"0x0f3ee15" == IsTask in CWindows.cls
'"0x0f3ee16" == SwitchTo in CWindows.cls
'"0x0f3ee17" == FillTaskList in CWindows.cls
'"0x0f3ee18" == LoadListView in ModListView.bas
'"0x0f3ee19" == GetList in ModListView.bas
'"0x0f3ee110" == cmdshowwindow_Click in frmmain.frm
'"0x0f3ee111" == Lstwindows_ItemClick in frmmain.frm
'"0x0f3ee112" == cmdHide_Click in frmmain.frm
'"0x0f3ee113" == cmdShowAll_Click in frmmain.frm
'"0x0f3ee114" == CmdHideAll_Click in frmmain.frm
'"0x0f3ee115" == CmdRevert_Click in frmmain.frm
...
'"0x0f3ee120" == LoadSysTrayList in ModSysTrayList.bas
'"0x0f3ee121" == CheckSysTrayList in ModSysTrayList.bas
'"0x0f3ee122" == GetHwndTray in ModSysTrayList.bas
'"0x0f3ee123" == HideMe in frmmain.frm
'"0x0f3ee124" == ShowMe in frmmain.frm
...
Public Const SoftwareName = "Easy Window & System Tray Icons Hider"
Public Const SiteName = "http://www.perfectiontools.com"
Public Const IniFileName = "hider.ini"
