...
'//* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    lstShortCutKeys.ListItems.Add , Hide_SysTrayIcons, Hide_SysTrayIcons
    lstShortCutKeys.ListItems.Add , Hide_All_Windows, Hide_All_Windows
    lstShortCutKeys.ListItems.Add , Hide_Desktop_Icons, Hide_Desktop_Icons
    lstShortCutKeys.ListItems.Add , Hide_Foreground_Window, Hide_Foreground_Window
    lstShortCutKeys.ListItems.Add , Hide_Me, Hide_Me
    lstShortCutKeys.ListItems.Add , Show_SysTrayIcons, Show_SysTrayIcons
    '//lstShortCutKeys.ListItems.Add , RevertWindowsVisibilty, RevertWindowsVisibilty
    lstShortCutKeys.ListItems.Add , Show_All_Windows, Show_All_Windows
    ...
    lstShortCutKeys.ListItems.Add , Show_Desktop_Icons, Show_Desktop_Icons
    lstShortCutKeys.ListItems.Add , Show_Me, Show_Me
...
'//* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   ...
   WriteToINIProfile Hide_SysTrayIcons, lstShortCutKeys.ListItems.Item(1).SubItems(2)
   WriteToINIProfile Hide_All_Windows, lstShortCutKeys.ListItems.Item(2).SubItems(2)
   WriteToINIProfile Hide_Desktop_Icons, lstShortCutKeys.ListItems.Item(3).SubItems(2)
   WriteToINIProfile Hide_Foreground_Window, lstShortCutKeys.ListItems.Item(4).SubItems(2)
   WriteToINIProfile Hide_Me, lstShortCutKeys.ListItems.Item(5).SubItems(2)
   WriteToINIProfile Show_SysTrayIcons, lstShortCutKeys.ListItems.Item(6).SubItems(2)
   ...
   WriteToINIProfile Show_All_Windows, lstShortCutKeys.ListItems.Item(7).SubItems(2)
   '//pt 1July2007: commented next line to Delete Show Foreground Window Shortcut key
   '//WriteToINIProfile Show_Foreground_Window, lstShortCutKeys.ListItems.Item(5).SubItems(2)
   WriteToINIProfile Show_Desktop_Icons, lstShortCutKeys.ListItems.Item(8).SubItems(2)
   WriteToINIProfile Show_Me, lstShortCutKeys.ListItems.Item(9).SubItems(2)
   'el tarteeb is very importatn here by the order in the listview
   '//1.don't forget to order in the same order in the listview
   ...
   WriteToINIProfile "chkGray", chkGray.Value
   ...
   WriteToINIProfile "chkHideMe", chkHideMe.Value
   WriteToINIProfile "chkStartUp", chkStartUp.Value
   WriteToINIProfile "chkHotTrack", chkHotTrack.Value
   WriteToINIProfile "chkShowTopMost", chkShowTopMost.Value
   WriteToINIProfile "chkReverseState", chkReverseState.Value
   WriteToINIProfile "chkMinInsteadOfClosing", chkMinInsteadOfClosing.Value
     
   IsHotTrack = chkHotTrack.Value
   ...
   IsShowTopMost = chkShowTopMost.Value
   
   '//pt 2Feb2008 6:25PM : add next line to enable Run the software at startup
   ...
   Else
      ...
      DeleteShortcut AppPath & SoftwareName & ".exe", "Startup", SoftwareName
