...
'//* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    ''No Need''lstShortCutKeys.ListItems.Add , Hide_SysTrayIcons, Hide_SysTrayIcons
    ''No Need''lstShortCutKeys.ListItems.Add , Hide_All_Windows, Hide_All_Windows
    ''No Need''lstShortCutKeys.ListItems.Add , Hide_Desktop_Icons, Hide_Desktop_Icons
    ''No Need''lstShortCutKeys.ListItems.Add , Hide_Foreground_Window, Hide_Foreground_Window
    ''No Need''lstShortCutKeys.ListItems.Add , Hide_Me, Hide_Me
    ''No Need''lstShortCutKeys.ListItems.Add , Show_SysTrayIcons, Show_SysTrayIcons
    '//lstShortCutKeys.ListItems.Add , RevertWindowsVisibilty, RevertWindowsVisibilty
    ''No Need''lstShortCutKeys.ListItems.Add , Show_All_Windows, Show_All_Windows
    ...
    ''No Need''lstShortCutKeys.ListItems.Add , Show_Desktop_Icons, Show_Desktop_Icons
    ''No Need''lstShortCutKeys.ListItems.Add , Show_Me, Show_Me
    ...
    If tbsOptions.SelectedItem.Caption = "General" Then
        ...
        optmini.Visible = True
        optnever.Visible = True
   ...
   ElseIf tbsOptions.SelectedItem.Caption = "Keyboard Shortcuts" Then
         ...
         optmini.Visible = False
         optnever.Visible = False
...
'//* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   ...
   ''NoNeed''WriteToINIProfile Hide_SysTrayIcons, lstShortCutKeys.ListItems.Item(1).SubItems(2)
   ''NoNeed''WriteToINIProfile Hide_All_Windows, lstShortCutKeys.ListItems.Item(2).SubItems(2)
   ''NoNeed''WriteToINIProfile Hide_Desktop_Icons, lstShortCutKeys.ListItems.Item(3).SubItems(2)
   ''NoNeed''WriteToINIProfile Hide_Foreground_Window, lstShortCutKeys.ListItems.Item(4).SubItems(2)
   ''NoNeed''WriteToINIProfile Hide_Me, lstShortCutKeys.ListItems.Item(5).SubItems(2)
   ''NoNeed''WriteToINIProfile Show_SysTrayIcons, lstShortCutKeys.ListItems.Item(6).SubItems(2)
   ...
   ''NoNeed''WriteToINIProfile Show_All_Windows, lstShortCutKeys.ListItems.Item(7).SubItems(2)
   '//pt 1July2007: commented next line to Delete Show Foreground Window Shortcut key
   '//WriteToINIProfile Show_Foreground_Window, lstShortCutKeys.ListItems.Item(5).SubItems(2)
   ''NoNeed''WriteToINIProfile Show_Desktop_Icons, lstShortCutKeys.ListItems.Item(8).SubItems(2)
   ''NoNeed''WriteToINIProfile Show_Me, lstShortCutKeys.ListItems.Item(9).SubItems(2)
   'el tarteeb is very importatn here by the order in the listview
   '//1.don't forget to order in the same order in the listview
   ...
   ''NoNeed''WriteToINIProfile "chkGray", chkGray.Value
   
   If optmini.Value Then
      WriteToINIProfile "optmini", 1
   Else
      WriteToINIProfile "optmini", 0
   End If
   
   If optnever.Value Then
      WriteToINIProfile "optnever", 1
   Else
      WriteToINIProfile "optnever", 0
   End If
   
   If optalways.Value Then
      WriteToINIProfile "optalways", 1
   Else
      WriteToINIProfile "optalways", 0
   End If
   
   ''NoNeed''WriteToINIProfile "chkHideMe", chkHideMe.Value
   WriteToINIProfile "chkStartUp", chkStartUp.Value
   WriteToINIProfile "chkAllowMonitor", chkAllowMonitor.Value
   WriteToINIProfile "chkCheckatStartup", chkCheckatStartup.Value
   WriteToINIProfile "chkRemoved", chkRemoved.Value
   WriteToINIProfile "chkNewlyAdded", chkNewlyAdded.Value
    
   ''NoNeed''WriteToINIProfile "chkHotTrack", chkHotTrack.Value
   ''NoNeed''WriteToINIProfile "chkShowTopMost", chkShowTopMost.Value
   ''NoNeed''WriteToINIProfile "chkReverseState", chkReverseState.Value
   WriteToINIProfile "chkMinInsteadOfClosing", chkMinInsteadOfClosing.Value
     
   ''NoNeed''IsHotTrack = chkHotTrack.Value
     
   IsAlwaysTrayIcon = optalways.Value
   
   IsNeverTrayIcon = optnever.Value
   
   IsTrayIconOnlyWhenMini = optmini.Value
   
   ''NoNeed''IsShowTopMost = chkShowTopMost.Value
   
   IsRunAtStartUp = chkStartUp.Value
   
   rCheckatStartup = chkCheckatStartup.Value
   
   rMonitorAllowed = chkAllowMonitor.Value
   
   rchkNewlyAdded = chkNewlyAdded.Value
   
   rchkRemoved = chkRemoved.Value
   ...
   '//pt 07Apr2008 04:44 pm : For unknown reason : if the sort is enabled, adding a new item wrongly doesn't added after the last
   ...
   '//Set TopMost or not
   ''NoNeed''If IsShowTopMost Then
   ''NoNeed''   SetWindowPos frmmain.hwnd, HWND_TOPMOST, 0, 0, 0, 0, SWP_NOACTIVATE Or SWP_SHOWWINDOW Or SWP_NOMOVE Or SWP_NOSIZE
   ''NoNeed''Else
   ''NoNeed''   SetWindowPos frmmain.hwnd, HWND_NOTOPMOST, 0, 0, 0, 0, SWP_NOACTIVATE Or SWP_SHOWWINDOW Or SWP_NOMOVE Or SWP_NOSIZE
   ''NoNeed''End If
...
'//* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   ...
   WriteToINIProfile Hide_SysTrayIcons, "1,1,0#" & DefChar8 & "*"
   WriteToINIProfile Hide_All_Windows, "1,1,0#" & DefChar3 & "*"
   WriteToINIProfile Hide_Desktop_Icons, "1,1,0#" & DefChar10 & "*"
   WriteToINIProfile Hide_Foreground_Window, "1,1,0#" & DefChar4 & "*"
   WriteToINIProfile Hide_Me, "1,1,0#" & DefChar1 & "*"
   WriteToINIProfile Show_SysTrayIcons, "1,1,0#" & DefChar9 & "*"
   '//pt 1July2007: commented next line to Delete Revert Shortcut key
   '//WriteToINIProfile RevertWindowsVisibilty, "1,1,0#" & DefChar2 & "*"
   WriteToINIProfile Show_All_Windows, "1,1,0#" & DefChar5 & "*"
   '//pt 1July2007: commented next line to Delete Show Foreground Window Shortcut key
   '//WriteToINIProfile Show_Foreground_Window, "1,1,0#" & DefChar6 & "*"
   WriteToINIProfile Show_Desktop_Icons, "1,1,0#" & DefChar11 & "*"
   WriteToINIProfile Show_Me, "1,1,0#" & DefChar7 & "*"
   'el tarteeb is very importatn here by the order in the listview
   '//1.don't forget to order in the same order in the listview
...
'//* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   ...
   '//pt 1July2007: commented next line to Delete Show Foreground Window Shortcut key
   '//DefChar6 = Str(Asc("F")) '//Get the ASC value of F
   DefChar7 = Str(Asc("N")) '//Get the ASC value of F
   DefChar8 = Str(Asc("X")) '//Get the ASC value of F
   DefChar9 = Str(Asc("Z")) '//Get the ASC value of F
   '//DefCharX = Str(Asc("Code Here")) '//ShortCut How To
   DefChar10 = Str(Asc("D")) '//Get the ASC value of F
   DefChar11 = Str(Asc("F")) '//Get the ASC value of F
   ...
   If InStr(1, dkey, "#") <> 0 Then '//if it is not a blank field
        ...
        lstShortCutKeys.ListItems.Item(Hide_All_Windows).SubItems(1) = DecodeKey(dkey)
        '//write the endcoded value to the hidden column
        lstShortCutKeys.ListItems.Item(Hide_All_Windows).SubItems(2) = dkey
        lstShortCutKeys.ListItems.Item(Hide_All_Windows).ListSubItems(2).ForeColor = vbWhite
   End If
   ...
   If InStr(1, dkey, "#") <> 0 Then
        lstShortCutKeys.ListItems.Item(Show_All_Windows).SubItems(1) = DecodeKey(dkey)
        '//write the endcoded value to the hidden column
        lstShortCutKeys.ListItems.Item(Show_All_Windows).SubItems(2) = dkey
        lstShortCutKeys.ListItems.Item(Show_All_Windows).ListSubItems(2).ForeColor = vbWhite
   End If
   ...
   If InStr(1, dkey, "#") <> 0 Then
        lstShortCutKeys.ListItems.Item(Hide_Foreground_Window).SubItems(1) = DecodeKey(dkey)
        '//write the endcoded value to the hidden column
        lstShortCutKeys.ListItems.Item(Hide_Foreground_Window).SubItems(2) = dkey
        lstShortCutKeys.ListItems.Item(Hide_Foreground_Window).ListSubItems(2).ForeColor = vbWhite
   End If
   ...
   If InStr(1, dkey, "#") <> 0 Then
        lstShortCutKeys.ListItems.Item(Hide_Me).SubItems(1) = DecodeKey(dkey)
        '//write the endcoded value to the hidden column
        lstShortCutKeys.ListItems.Item(Hide_Me).SubItems(2) = dkey
        lstShortCutKeys.ListItems.Item(Hide_Me).ListSubItems(2).ForeColor = vbWhite
   End If
  
   '//pt 1July2007: commented next clause to Delete Show Foreground Window Shortcut key
   '//dkey = "" '//we must clear dkey otherwise it may hold the value of the previous use
   '//and this will cause a bug in displaying the key
   '//for example: if a function has no key, then it will be stored as a blank value in ini
   '//and if dkey has this value from the prevoius use "1,1,1#256*" , then
   ...
   '//If InStr(1, dkey, "#") <> 0 Then
   '//     lstShortCutKeys.ListItems.Item(Show_Foreground_Window).SubItems(1) = DecodeKey(dkey)
        '//write the endcoded value to the hidden column
   '//     lstShortCutKeys.ListItems.Item(Show_Foreground_Window).SubItems(2) = dkey
   '//     lstShortCutKeys.ListItems.Item(Show_Foreground_Window).ListSubItems(2).ForeColor = vbWhite
   ...
   If InStr(1, dkey, "#") <> 0 Then
      lstShortCutKeys.ListItems.Item(Show_Me).SubItems(1) = DecodeKey(dkey)
      '//write the endcoded value to the hidden column
      lstShortCutKeys.ListItems.Item(Show_Me).SubItems(2) = dkey
      lstShortCutKeys.ListItems.Item(Show_Me).ListSubItems(2).ForeColor = vbWhite
   End If
   ...
   If InStr(1, dkey, "#") <> 0 Then
      lstShortCutKeys.ListItems.Item(Hide_SysTrayIcons).SubItems(1) = DecodeKey(dkey)
      '//write the endcoded value to the hidden column
      lstShortCutKeys.ListItems.Item(Hide_SysTrayIcons).SubItems(2) = dkey
      lstShortCutKeys.ListItems.Item(Hide_SysTrayIcons).ListSubItems(2).ForeColor = vbWhite
   End If
   ...
   If InStr(1, dkey, "#") <> 0 Then
      lstShortCutKeys.ListItems.Item(Show_SysTrayIcons).SubItems(1) = DecodeKey(dkey)
      '//write the endcoded value to the hidden column
      lstShortCutKeys.ListItems.Item(Show_SysTrayIcons).SubItems(2) = dkey
      lstShortCutKeys.ListItems.Item(Show_SysTrayIcons).ListSubItems(2).ForeColor = vbWhite
   End If
   ...
   If InStr(1, dkey, "#") <> 0 Then
      lstShortCutKeys.ListItems.Item(Hide_Desktop_Icons).SubItems(1) = DecodeKey(dkey)
      '//write the endcoded value to the hidden column
      lstShortCutKeys.ListItems.Item(Hide_Desktop_Icons).SubItems(2) = dkey
      lstShortCutKeys.ListItems.Item(Hide_Desktop_Icons).ListSubItems(2).ForeColor = vbWhite
   End If
   ...
   If InStr(1, dkey, "#") <> 0 Then
      lstShortCutKeys.ListItems.Item(Show_Desktop_Icons).SubItems(1) = DecodeKey(dkey)
      '//write the endcoded value to the hidden column
      lstShortCutKeys.ListItems.Item(Show_Desktop_Icons).SubItems(2) = dkey
      lstShortCutKeys.ListItems.Item(Show_Desktop_Icons).ListSubItems(2).ForeColor = vbWhite
   End If
...
'//* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   ...
   If res Then chkGray.Value = 1
   
   res = GetINIProfileInt("optmini", 1)
   
   If res Then optmini.Value = True
   
   res = GetINIProfileInt("optalways", 0)
   
   If res Then optalways.Value = True
    
   res = GetINIProfileInt("optnever", 0)
   
   If res Then optnever.Value = True
   
   res = GetINIProfileInt("chkHideMe", 1)

   If res Then chkHideMe.Value = 1
   
   res = GetINIProfileInt("chkMinInsteadOfClosing", 0)

   If res Then chkMinInsteadOfClosing.Value = 1
     
   res = GetINIProfileInt("chkReverseState", 1)

   If res Then
      
      chkReverseState.Value = 1
      
      res = GetINIProfileInt("chkHotTrack", 1)

      If res Then
         
         chkHotTrack.Enabled = True
   ...
   If res Then chkShowTopMost.Value = 1
       
   res = GetINIProfileInt("chkCheckatStartup", 0)

   If res Then chkCheckatStartup.Value = 1
       
   res = GetINIProfileInt("chkAllowMonitor", 1)

   If res Then chkAllowMonitor.Value = 1
   
   res = GetINIProfileInt("chkRemoved", 1)

   If res Then chkRemoved.Value = 1
   
   res = GetINIProfileInt("chkNewlyAdded", 1)

   If res Then chkNewlyAdded.Value = 1
   
   chkRemoved.Enabled = chkAllowMonitor.Enabled
   
   chkNewlyAdded.Enabled = chkAllowMonitor.Enabled
